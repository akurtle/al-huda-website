        ...
        <div className="community-layout">
          ...
          <div className="community-events">
            ...
            <div className="event-card">
              <div className="event-badge">Every Friday</div>
              <h4>Jumu'ah Prayer</h4>
              <div className="event-details">
                ...
                <div className="event-detail">
                  ...
                  <span>Park Place, Mount Pearl</span>
                </div>
              </div>
            </div>

            <div className="event-card">
              <div className="event-badge accent">Ramadan</div>
              <h4>Ramadan Iftar Package</h4>
              <p className="event-desc">
                Community iftar gatherings fostering unity and spiritual connection during the blessed month.
              </p>
            </div>

            <div className="event-card">
              <div className="event-badge">Weekends</div>
              <h4>Weekend Islamic Classes</h4>
              <div className="event-details">
                <div className="event-detail">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <circle cx="12" cy="12" r="10"/>
                ...
                <div className="event-detail">
                  ...
                  <span>Memorial University, Chemistry Building</span>
                </div>
              </div>
            </div>
          </div>
